...
//       // Filter for this user AND sort by date immediately
...
//                   {/* CHANGED DATA KEY: Now matches 'service' from your new formData */}
...
//                   <td className="p-8">
//                     {/* UPDATED COLOR LOGIC: Handles 'rejected' with red theme */}

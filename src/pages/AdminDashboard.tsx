...
// import { User, Search, ChevronRight, Mail, Hash, Users, Briefcase, FileWarning } from 'lucide-react'; 
...
//           // Check if this specific request has documents
//           if (req.documents && req.documents.length > 0) {
//             acc[userId].hasUnreviewedDocs = true;
//           }
...
//         const finalSortedArray = Object.values(groups).sort((a: any, b: any) => 
...
//           <div>
//             <h1 className="text-4xl font-black text-slate-900 tracking-tight">Client Directory</h1>
//             <p className="text-slate-500 font-medium">Manage registered clients and view their document submissions.</p>
//           </div>
...
//              <p className="font-black text-slate-400 uppercase tracking-widest text-xs">Loading Directory...</p>
//            </div>
...
//                 className="group bg-white p-8 rounded-[2.5rem] shadow-sm hover:shadow-2xl hover:-translate-y-1 transition-all cursor-pointer border border-slate-100 relative"
//               >
//                 {/* Notification Badge for Documents */}
//                 {client.hasUnreviewedDocs && (
//                   <div className="absolute top-6 right-6 flex items-center gap-1 bg-amber-100 text-amber-700 px-2 py-1 rounded-lg animate-pulse">
//                     <FileWarning size={14} />
//                     <span className="text-[10px] font-black uppercase">Docs Sent</span>
//                   </div>
//                 )}
...
//                     <span className="text-[10px] font-black uppercase text-slate-400">Latest Activity</span>
//                     <span className="text-xs font-bold text-slate-700 italic">{client.latestService}</span>
//                   </div>
